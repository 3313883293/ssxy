...
const PASSIVE_INFO = {
    '鲁盼旋': [
        ...
        '惩恶之火：友方受伤时，伤害来源获得1层「恶」；回合结束时，获得场上总「恶」层数的「愤怒」；友方阵亡时愤怒+3级；技能命中时施加分配硬币数级「燃烧」（目标「燃烧」≤3层且自身「愤怒」≥1级时，消耗1级额外+1层）',
        '愤怒（上限5级）：每2级基础伤害+100、每2级防御-50；不回复算力（不受通用触发影响）'
    ],
    '模板一': [], '模板二': [], '模板三': [],
    '持盾警察': [], '持棍警察': [], '持枪警察': [],
    ...
    '云长郡': [
        '「怨恨」（特殊情感激荡，上限10级）：受击减伤 = 100% − 怨恨等级×15%，跌破0%转为受到伤害加成；每3级基础伤害+50、防御-50；同阵营（含召唤的警察怨灵）阵亡怨恨+1级；不回复算力；减伤每回合开始判定',
        '召唤怨灵：每回合开始时若场上只剩自己且召唤池非空，召唤2个警察怨灵（池：2持盾2持棍4持枪2车，怨灵为原单位一半血量与初始算力，怨灵车为25%血量）'
    ],
    '灼华': [
