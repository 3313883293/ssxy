...
const LEVEL_INFO = [
    ...
    { title: '☠️ 第四关 · Boss', desc: '云长郡 ×1（亡灵怨恨）', enemies: ['云长郡'], intro: '鲁盼旋将与你们并肩作战（锁定 1 号位，由 AI 操控），再选 2 名上场 + 1 名待命。云长郡的「怨恨」等级驱动亡灵怨恨减伤：受击减伤 = 100% − 等级×15%（上限10级），同阵营（含其召唤的警察怨灵）阵亡怨恨+1级，怨恨满7级减伤跌破0%转受击加伤；注意【催眠气体释放】会使目标「暂时昏迷」。机制细节见其被动。' },
