...
const LEVEL_INFO = [
    { title: '第一关', desc: '持盾警察 ×1　持棍警察 ×1　持枪警察 ×1', enemies: ['持盾警察', '持棍警察', '持枪警察'], intro: '持棍警察【一秒18棍】为 18 段多段攻击，持枪警察【开火】远程高伤，建议优先集火持枪警察。' },
    ...
    { title: '第四关 · Boss', desc: '云长郡 ×1（亡灵怨恨）', enemies: ['云长郡'], intro: '鲁盼旋将与你们并肩作战（锁定最前排，AI 操控），再选 2 名上场 + 1 名待命。云长郡的「怨恨」等级驱动亡灵怨恨减伤：受击减伤 = 100% − 等级×15%（上限 10 级），同阵营（含其召唤的警察怨灵）阵亡怨恨 +1 级，怨恨满 7 级减伤跌破 0% 转受击加伤。怨恨每 3 级基础伤害 +50、防御 -50。注意【催眠气体释放】会使目标「暂时昏迷」。机制细节见其被动。' },
    ...
    { title: '🔥 第三关 · Boss', desc: '焚天祭司·烛央 ×1　焦木傀儡 ×2', enemies: ['焚天祭司·烛央', '焦木傀儡'], intro: '灼华将与你们并肩作战（锁定最前排，AI 操控），再选 2 名上场 + 1 名待命。烛央【薪火不息】把场上燃烧吸成【狂炎】而变强（每层 +150 伤害 / -20 防御），烧得越猛它越疯——是双刃剑。机制细节见其被动。' },
    // v0.6 张子曦篇（level 7/8）——关卡配置为占位骨架，敌人/特殊胜利待用户后补
    { title: '🌀 第一关', desc: '烬火信徒 ×2　引火学徒 ×1', enemies: ['烬火信徒', '引火学徒'], intro: '张子曦篇·占位配置（敌人待用户后补）。主题机制「混乱」：目标受击后按本次分配硬币数触发反噬，每次消耗 1 层并造成 级数×20 真实伤害。' },
