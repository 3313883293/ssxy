...
function showRoleInfo(roleName) {
    ...
    if (roleName === '鲁盼旋') {
        ...
        html += '<div class="rd-passive">黎明级先天能力者：回合结束时，若本回合未使用技能，则回复200算力</div>';
        html += '<div class="rd-passive">惩恶之火：友方受伤时，伤害来源获得1层【恶】回合结束时，获得场上总恶层数的【愤怒】友方角色死亡时，获得3层【愤怒】 技能命中时，施加分配硬币数级【燃烧】</div>';
        html += '</div>';
    } else if (roleName === '模板一' || roleName === '模板二' || roleName === '模板三') {
        html += '<div class="rd-section"><div class="rd-section-title">🔰 被动</div>';
