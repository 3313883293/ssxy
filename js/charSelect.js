...
const LEVEL_INFO = [
    ...
    { title: '第三关', desc: '李雅礼 ×1　持枪警察 ×2 ＋ 开车警察待命', enemies: ['李雅礼', '持枪警察', '开车警察'], intro: '李雅礼死后会倒戈为我方（详见其被动），持枪警察远程高伤，前排死亡后开车警察入场补位。' },
    { title: '第四关 · Boss', desc: '云长郡 ×1（亡灵怨恨）', enemies: ['云长郡'], intro: '鲁盼旋将与你们并肩作战（锁定最前排，AI 操控），再选 2 名上场 + 1 名待命。云长郡的「怨恨」随队友死亡升级：怨恨越高减伤越强，过高时转为受击加伤；等级提升还会获得伤害加成与防御削减——越战越强，也会越打越脆。注意【催眠气体释放】会使目标「暂时昏迷」。机制细节见其被动。' },
    ...
    // v0.6 张子曦篇（level 7/8）；v0.684 第一关定为多能战警×3（装备切换阵型），第二关仍占位
    { title: '🌀 第一关', desc: '多能战警 ×3', enemies: ['多能战警'], intro: '三名多能战警组成防爆/步枪/狙击三装备阵型——回合开始按站位自动切换装备并换用对应技能，前排防爆装近身压制、后排狙击装远距离重创，警惕【交叉火力】连携。任意一名血量 ≤40% 会战术撤退休整，补位归来时带回「休整」。优先集火狙击装（脆但输出高），或集中压低一名使其撤退、拆散阵型。' },
...
function getRoleDefRange(roleName) {
    const defMap = {
        '模板一': 200, '模板二': 100, '模板三': 300, '鲁盼旋': 200, '灼华': 150, '张子曦': 150, '王庄明': 300, '曹佳梦': 100,
...
function getRoleSpeedRange(roleName) {
    const spdMap = {
        '模板一': '2~6', '模板二': '4~7', '模板三': '1~4', '鲁盼旋': '4~6', '灼华': '3~6', '张子曦': '3~6', '王庄明': '2~5', '曹佳梦': '3~6',
        '持盾警察': '1~3', '持棍警察': '2~5', '持枪警察': '3~7',
        '开车警察': '3~7', '李雅礼': '1~7', '云长郡': '2~6', '多能战警': '1~4',   // v0.684 多能战警（装备切换会临时改变速度）
