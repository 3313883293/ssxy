...
const GLOSSARY = {
    ...
    '燃烧': { title: '燃烧', desc: '持续伤害状态：回合结束时受到等级 × 50 真实伤害。每回合至少消耗 1 层（等级每满 5 级再多消耗 1 层），层数耗尽后燃烧结束；若层数不足，按剩余层数 × 5 级一次结算并结束燃烧。' },
    ...
    '创伤': { title: '创伤', desc: '多能战警施加的伤口反噬状态：被攻击投掷硬币时触发（次数 = 本次分配到目标身上的硬币数），每次造成 级数×20 真实伤害并消耗 1 层，层数耗尽后消失。' },
